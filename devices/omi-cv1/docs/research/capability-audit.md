...
| Audio input | Two T5838 PDM microphones | 16 kHz, 16-bit interleaved capture; firmware averages both channels to mono and encodes Opus | Bounded stock witness delivered 532 mono Opus frames over 9,999 ms with no sequence gaps/discontinuities, payload 71–120 bytes, and no retained content. Per-microphone identity, acoustic quality, clipping, and current remain unmeasured | Reuse PDM and Opus paths; preserve stereo during experiments |
...
| BLE | nRF5340 radio | Active GATT data plane, 2M/Coded PHY configuration, one connection, OTA, live audio, and offline sync. Current upstream Android requests ATT MTU 512 after discovery | 11 services/21 characteristics plus operational Gumi driver negotiation at MTU 23/2M/2M; bounded audio qualified at MTU 498/2M/2M and `NOT_BONDED`, with 532 frames over 9,999 ms and no gaps. Reconnect/background behavior remains pending | Primary device-to-edge transport for M1 |
